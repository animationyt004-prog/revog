...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      onClick={() => pixelTrack("Contact", { contact_method: "whatsapp" })}
      className="whatsapp-button fixed bottom-5 right-4 z-50 grid h-12 w-12 place-items-center rounded-full bg-[#25D366] p-3 shadow-[0_8px_28px_rgba(0,0,0,0.22)] transition-transform hover:scale-105 sm:right-5 sm:h-13 sm:w-13 sm:p-3.5"
    >
