...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 grid h-13 w-13 place-items-center rounded-full bg-[#25D366] p-3.5 shadow-[0_6px_20px_rgba(0,0,0,0.25)] transition-transform hover:scale-110"
    >
      {/* WhatsApp glyph (inline so no external asset) */}
