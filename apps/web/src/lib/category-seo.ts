...
export const CATEGORY_SEO: Record<string, CategorySeo> = {
  "oversized-tees": {
    ...
    paragraphs: [
      ...
      "Shopping with HyraLuxe is simple: transparent pricing, Cash on Delivery across serviceable pincodes, and easy 7-day returns if the fit isn't right.",
    ],
    faqs: [
      {
  ...
  sarees: {
    ...
    paragraphs: [
      ...
      "Shopping with HyraLuxe is simple: transparent pricing, Cash on Delivery across serviceable pincodes, and easy 7-day returns if a saree isn't right for you. New designs are added regularly, so bookmark this page and check back before your next occasion.",
    ],
    faqs: [
      {
  ...
  kurtis: {
    ...
    paragraphs: [
      ...
      "As always with HyraLuxe: transparent pricing, Cash on Delivery across serviceable pincodes, and easy 7-day returns if a kurti isn't right for you. New styles are added regularly, so check back before your next occasion.",
    ],
    faqs: [
      {
  ...
  "suit-sets": {
    ...
    paragraphs: [
      ...
      "Shopping with HyraLuxe stays simple: transparent pricing, Cash on Delivery across serviceable pincodes, and easy 7-day returns if a set doesn't suit you.",
    ],
    faqs: [
      {
  ...
  kurtas: {
    ...
    paragraphs: [
      ...
      "As with everything at HyraLuxe: transparent pricing, Cash on Delivery across serviceable pincodes, and easy 7-day returns if the kurta isn't right.",
    ],
    faqs: [
      {
  ...
  "kurta-sets": {
    ...
    paragraphs: [
      ...
      "HyraLuxe keeps the rest simple: transparent pricing, Cash on Delivery across serviceable pincodes, and easy 7-day returns if the set isn't right for the occasion.",
    ],
    faqs: [
      {
