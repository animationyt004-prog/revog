...
-- CreateEnum
CREATE TYPE "Fit" AS ENUM ('OVERSIZED', 'REGULAR', 'BAGGY', 'SLIM', 'RELAXED');

-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('DRAFT', 'PUBLISHED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "Badge" AS ENUM ('NEW', 'TRENDING', 'LIMITED', 'BESTSELLER', 'SALE');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER', 'PAYMENT', 'RETURN', 'PROMO', 'SYSTEM');
...
CREATE TABLE "Product" (
    ...
    "brand" TEXT NOT NULL DEFAULT 'NO CURFEW',
    "gender" "Gender" NOT NULL DEFAULT 'MEN',
    "fit" "Fit" NOT NULL DEFAULT 'OVERSIZED',
    "fabric" TEXT,
