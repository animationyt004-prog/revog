...
const copyBySlug: Record<string, Copy> = {
  'apple-feelmax-vol-1-printed-japan-satin-saree': {
    ...
    metaDescription:
      'Printed Japan satin saree with a glossy drape and contrast border. Lightweight, festive-ready, with matching blouse piece. Shop HYRA.',
  },
  'apple-harmony-vol-2-organza-printed-designer-saree': {
    ...
    metaDescription:
      'Sky-blue printed organza designer saree with a crisp floral drape and matching blouse piece. Perfect for daytime functions. Shop HYRA.',
  },
  'apple-laila-vol-1-organza-digital-printed-saree-collection': {
    ...
    metaDescription:
      'Beige digital-printed organza saree — featherlight, elegant, easy to drape, with matching blouse piece. Shop the Laila collection at HYRA.',
  },
  'apple-womaniya-34-bhagalpuri-silk-printed-saree-collection': {
    ...
    metaDescription:
      'Deep maroon Bhagalpuri silk printed saree with a smooth premium drape and matching blouse piece. Festive-ready. Shop HYRA.',
  },
  'apple-womaniya-32-bhagalpuri-silk-printed-saree-collection': {
    ...
    metaDescription:
      'Lavender-taupe Bhagalpuri silk printed saree — soft, refined, everyday-festive, with matching blouse piece. Shop HYRA.',
  },
  'apple-womaniya-35-traditional-wear-bhagalpuri-silk-saree-collection': {
    ...
    metaDescription:
      'Navy traditional Bhagalpuri silk saree with a classic print and matching blouse piece. Comfortable, ceremony-ready. Shop HYRA.',
  },
  'apple-nitya-silk-12-bhagalpuri-silk-printed-saree-collection': {
    ...
    metaDescription:
      'Navy Bhagalpuri silk printed saree with a festive glow and matching blouse piece. Soft, graceful drape. Shop the Nitya collection at HYRA.',
  },
  'apple-womaniya-vol-28-bhagalpuri-printed-silk-saree-collection': {
    ...
    metaDescription:
      'Royal-blue Bhagalpuri silk printed saree with white motifs and matching blouse piece. Lightweight, celebration-ready. Shop HYRA.',
  },
  'apple-indigo-vol-2-printed-bhagalpuri-silk-saree-collection': {
    ...
    metaDescription:
      'Royal-blue indigo-print Bhagalpuri silk saree — fresh, contemporary, soft drape, with matching blouse piece. Shop HYRA.',
  },
  'apple-3-gorgeous-party-wear-georgette-saree-collection': {
    ...
    metaDescription:
      'Wine party-wear georgette saree with a flowing drape and subtle sheen, plus matching blouse piece. Made for evenings. Shop HYRA.',
  },
};
